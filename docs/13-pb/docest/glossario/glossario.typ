...
#base-document.apply-base-document(
  ...
  Il documento di *glossario* nasce con lo scopo di andare a chiarire tutte i possibili dubbi e ambiguità che possono
  nascere nella terminologia utilizzata all'interno della documentazione di NoTIP. \
  Verranno esposte di seguito tutti quei termini che, come gruppo, consideriamo potenzialmente fraintendibili o di cui,
  semplicemente, preferiamo esplicitare il significato. \
