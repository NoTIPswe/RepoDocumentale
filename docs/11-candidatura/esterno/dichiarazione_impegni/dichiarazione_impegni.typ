...
#base-document.apply-base-document(
  ...
  La @tab:costi riassume la suddivisione delle ore per ciascun ruolo, con il relativo costo, e presenta di conseguenza il preventivo complessivo del progetto.
  ...
  @fig:percentuali riporta un grafico a torta rappresentativo dei dati precedentemente illustrati. Tale rappresentazione risulta utile per comprendere in modo immediato la distribuzione percentuale delle ore assegnate a ciascun ruolo nella realizzazione del progetto.
  ...
  La @tab:ruoli rappresenta la suddivisione delle ore per ruolo di ogni componente del team.
  Le ore produttive per ruolo sono state divise per sette, in quanto nessun membro del gruppo prevale ampiamente su altri in quanto a competenze in ruoli specifici.

  L'*assegnazione dei ruoli* verrà definita durante ogni sprint planning (ogni due settimane).
  In questa fase, a ciascun membro del team verranno assegnati uno o più ruoli in base a:
