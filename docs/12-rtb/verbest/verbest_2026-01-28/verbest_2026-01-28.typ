...
#base-report.apply-base-verbale(
  ...
  tra cui scelte architetturali relative alla sicurezza dei dati e le tecnologie da adottare per il backend. Il 
  confronto ha permesso di chiarire dubbi tecnici e di ricevere conferme dalla proponente.
  ...
  #base-report.report-point(
    ...
    decisions: [
      Viene concordato un approccio flessibile: si tenterà di organizzare la riunione per mercoledì (in modalità online)
      , con la possibilità di posticipare a venerdì se necessario, in base allo stato di avanzamento del POC. Per questo
       motivo seguiranno altre comunicazioni via telematica tra le due parti per aggiornarsi sullo stato dei lavori.
    ],
  )
