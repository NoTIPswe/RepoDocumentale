...
#base-report.apply-base-verbale(
  ...
  In data *12 dicembre 2025*, alle ore *08:40*, si è svolta una riunione interna del gruppo NoTIP in modalità virtuale sul server *Discord* ufficiale del team.
  La riunione si è conclusa alle ore *09:42*.

  Ordine del giorno:
  - Rivedere il caso d'uso relativo all'impersonificazione.
  - Possibile rinvio della versione 0.4.0 del documento #link("https://notipswe.github.io/docs/12-rtb/docest/analisi_requisiti.pdf")[Analisi dei requisiti].
  ...
  #base-report.report-point(
    discussion_point: [Possibile rinvio della versione 0.4.0 del documento #link("https://notipswe.github.io/docs/12-rtb/docest/analisi_requisiti.pdf")[Analisi dei requisiti].],
    discussion: [
      È emersa l'impossibilità di finalizzare il documento entro il prossimo Sprint. Le recenti modifiche strutturali apportate hanno comportato un onere di lavoro maggiore del previsto, rallentando la stesura.
    ],
    decisions: [
  ...
  La riunione si è conclusa alle ore 09:42. Il Gruppo entra nella fase conclusiva dello Sprint attuale; la Review e il Planning del prossimo Sprint sono fissati per *Lunedì 15 Dicembre*, data entro la quale si prevede il raggiungimento delle versioni dei documenti prefissati.
]
