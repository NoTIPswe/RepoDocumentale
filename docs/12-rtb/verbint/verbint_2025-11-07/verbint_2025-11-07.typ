...
#base-report.apply-base-verbale(
  ...
  #base-report.report-point(
    ...
    decisions: [
      ...
      *Primary life cycle process*\
      ...
      #h(1em)5.4 Operation, del quale verrà eseguita solamente la fase di Operational Testing.\
  ...
  Nella riunione il gruppo ha avuto modo di poter discutere approfonditamente di ogni singolo punto dell'Ordine del
  Giorno in maniera collaborativa ed in modo produttivo, dove ognuno ha potuto esprimere i propri pareri riguardo i
