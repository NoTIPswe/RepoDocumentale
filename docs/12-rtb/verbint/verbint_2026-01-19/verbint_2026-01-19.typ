...
#base-report.apply-base-verbale(
  ...
  In data *19 gennaio 2026*, alle ore *14:50*, si è svolta una riunione interna del gruppo NoTIP in modalità virtuale
  sul server *Discord* ufficiale del team. La riunione si è conclusa alle ore *16:20*.
  ...
  #base-report.report-point(
    ...
    decisions: [
      ...
      dell’avvicinarsi del periodo di consegna della RTB. Si decide pertanto di adottare una pianificazione più
      strutturata delle attività, prevedendo una suddivisione dei compiti maggiormente aderente alle effettive
      disponibilità temporali di ciascun componente, così da ridurre rallentamenti e sovraccarichi di lavoro.
    ],
  )
  ...
  #base-report.report-point(
    ...
    discussion: [
      Si è discusso riguardo la rotazione dei ruoli, con l'obiettivo di permettere a tutti i membri del gruppo di
      acquisire esperienza in diverse aree e di evitare sovraccarichi di lavoro su singoli individui.
    ],
    decisions: [
      L’assegnazione e la rotazione dei ruoli vengono ufficializzate tenendo conto delle disponibilità emerse durante la
      discussione, con l’obiettivo di garantire un’equa distribuzione del carico di lavoro e favorire l’acquisizione di
      competenze trasversali da parte di tutti i membri del gruppo.
    ],
  )
  ...
  #base-report.report-point(
    ...
    discussion: [
      La discussione si è focalizzata sulla redazione della documentazione, in particolare riguardo al proseguimento di
      tutti i documenti previsti e non ancora completati, non trascurando l'importanza di una buona organizzazione e
      pianificazione del lavoro per evitare ritardi e sovraccarichi di lavoro.
    ],
    decisions: [
      Si decide di proseguire con la redazione di tutta la documentazione prevista e non ancora completata, definendo
      una pianificazione delle attività più dettagliata e una chiara suddivisione dei compiti, al fine di garantire il
      rispetto delle scadenze e prevenire eventuali ritardi.
    ],
  )
