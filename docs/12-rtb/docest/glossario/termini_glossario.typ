#let terms = (
  ...
  "Cyclomatic Complexity": "Metrica software sviluppata da Thomas McCabe per misurare la complessità di un programma, calcolando il numero di percorsi linearmente indipendenti attraverso il suo grafo di flusso di controllo",
  // D
  ...
  // E
  "TEAC": "Acronimo di Time Estimate At Completion, è una previsione del tempo totale necessario per concludere il progetto, calcolata in base all'efficienza temporale riscontrata",
  "EAC": "Acronimo di Estimate At Completion, è un metrica cruciale nel Project Management che prevede il costo totale previsto al termine di un progetto, calcolato aggiungendo i costi effettivi alla stima di completamento rimanente",
  "editor": "Membro del gruppo incaricato della redazione o modifica di un documento all’interno del progetto",
  "EV": "Acronimo di Earned Value, è un metodo per confrontare e valutare il valore previsto ad una certa data con il valore di ciò che è stato effettivamente realizzato",
  // F
  ...
  "Indice di Gulpease": "Indice di leggibilità di un testo tarato sulla lingua italiana, esso utilizza la lunghezza delle parole in lettere anziché in sillabe",
  // H
  // I
  ...
  // K
  "KILO": "Acronimo di Kilo Lines of Code, è un termine usato in informatica per misurare la dimensione di un software",
