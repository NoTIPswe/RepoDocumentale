...
#base-document.apply-base-document(
  ...
  Dato che una ridotta esperienza potrebbe rendere inefficaci le mitigazioni inizialmente pianificate, è necessario prevedere un'ulteriore analisi anche degli errori di mitigazione al fine di apportare miglioramenti alle strategie adottate.
  ...
  #{
    figure(
      ...
      table(
        ...
        [Descrizione],
        [A causa della poca conoscenza o dell'inesperienza, il gruppo potrebbe incontrare difficoltà nella comprensione e utilizzo delle tecnologie richieste nel progetto, causando un progressivo rallentamento nello sviluppo.],

        [Mitigazione],
        [Appena stabilite le tecnologie da utilizzare, è bene stabilire un periodo di "palestra" per formarsi al meglio, dato che questo problema potrebbe presentarsi anche dopo questo periodo, qualora fosse un problema generale, il gruppo organizzerà un meeting con _M31_ per chiedere chiarimenti sulla tecnologia. Dato che non è garantito lo stesso livello di conoscenza tra i componenti, è più probabile che i problemi vengano risolti internamente al gruppo.],
  ...
  #{
    figure(
      ...
      caption: [Mancato rispetto delle scadenza stabilites],
    )
  }<tab:RO1>
  == Rischi personali
  #{
  ...
  Come anticipato nella #link("https://notipswe.github.io/docs/11-candidatura/docest/dichiarazione_impegni.pdf")[Dichiarazione degli impegni], il gruppo prevede di terminare il progetto entro il giorno *21 Marzo 2026* con un budget di spesa fissato a *12.940 Euro*.\
  Al momento della candidatura si è teorizzato la seguente previsione dei costi:
  #{
    figure(
      numbering: "1",
      table(
  ...
  === Ore previste
  A seguito di una mancanza di organizzazione delle ore previste, il gruppo non ha lavorato nella maniera corretta, per questo si potrebbe vedere uno squilibrio nelle ore effettive.
  Il gruppo nel prossimo Sprint si impegnerà ad organizzarsi e rispettare le ore previste.
