...
+ Il Sistema esegue la pulizia: elimina l'associazione col Tenant, cancella i dati storici, revoca il certificato
  digitale e registra l'operazione nell'audit log.\
*Scenari alternativi:* \
