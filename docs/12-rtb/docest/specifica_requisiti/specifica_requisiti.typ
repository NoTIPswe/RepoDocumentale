...
#base-document.apply-base-document(
  ...
  *Trigger:* L'Amministratore di Sistema deve decidere l'allocazione delle risorse per garantire isolamento o performance.\
  ...
  === UC2 - Dati Tenant Non Validi <UC2>
  *Attore principale:* Amministratore Sistema\
  *Pre-condizioni:* \
  ...
  *Attore principale:* Amministartore Sistema / Amministratore Tenant\
  *Pre-condizioni:* \
  - La configurazione del Gateway è in corso.\
  *Post-condizioni:* \
  ...
  *Trigger:* Dismissione hardware, fine contratto o compromissione di sicurezza.\
  ...
  === UC14 - Dati Gateway Non Validi <UC14>
  *Attore principale:* Amministratore Sistema / Amministratore Tenant\
  *Pre-condizioni:* \
  ...
  *Trigger:* Inserimento di dati non conformi alle regole di validazione.\
  ...
  === UC15 - Errore Comunicazione o Stato Gateway <UC15>
  *Attore principale:* Amministratore Sistema / Amministratore Tenant\
  *Pre-condizioni:* \
  ...
  *Attore principale:* Amministratore Sistema / Amministratore Tenant / Utente del Tenant\
  *Pre-condizioni:* \
  ...
  *Trigger:* Dismissione fisica del sensore o errore di registrazione.\
  ...
  === UC21 - Dati Sensore Non Validi  <UC21>
  *Attore principale:* Amministratore Sistema / Amministratore Tenant\
  *Pre-condizioni:* \
  ...
  *Trigger:* Input dati errato o conflitto di configurazione.\
  ...
  === UC22 - Errore Operazione Sensore  <UC22>
  *Attore principale:* Amministratore Sistema / Amministratore Tenant\
  *Pre-condizioni:* \
  ...
  *Trigger:* Guasto infrastrutturale momentaneo.\
  ...
  === UC23 - Autenticazione Client API <UC29>
  ...
  *Trigger:* Selezione del contesto di monitoraggio.\
  ...
  === UC32 - Errore Autenticazione API  <UC32>
  *Attore principale:* Client Esterno\
  *Pre-condizioni:* \
  ...
  *Trigger:* Utilizzo di credenziali invalide o scadute da parte del client.\
  ...
  === UC33 - Errore Richiesta o Limite API  <UC33>
  *Attore principale:* Client Esterno\
  *Pre-condizioni:* \
  ...
  *Attore principale:* Amministartore Sistema / Amministartore Tenant / Utente del Tenant\
  *Pre-condizioni:* \
  ...
  *Trigger:* Revoca accesso a ex-dipendenti o collaboratori esterni.\
  ...
  === UC45 - Errore Autenticazione  <UC45>
  *Attore principale:* Amministratore Sistema / Amministratore Tenant / Utente del Tenant\
  *Pre-condizioni:* \
  ...
  *Trigger:* Input credenziali errate da parte dell'utente.\
  ...
  === UC46 - Fallimento Caricamento o Salvataggio Dati  <UC46>
  *Attore principale:* Amministratore Sistema / Amministratore Tenant / Utente del Tenant\
  *Pre-condizioni:* \
  ...
  *Attore principale:* Amministratore di Sistema / Amministratore del Tenant\
  *Pre-condizioni:* \
  ...
  *Trigger:* Gestione operativa di un incidente.\
  ...
  === UC50 - Errore Gestione Alert  <UC50>
  ...
  *Trigger:* Compliance legale (GDPR) o ottimizzazione costi storage.\
  ...
  === UC58 - Errore Operazione Critica <UC58>
  *Attore principale:* Amministratore Sistema / Amministratore Tenant\
  *Pre-condizioni:* \
  ...
  *Trigger:* Malfunzionamento dei servizi di storage o database.\
  ...
  === UCS1 - Configurazione Dati Simulati <UCS1>
  ...
  *Trigger:* Necessità di definire il comportamento verosimile dei sensori.\
  ...
  ==== UCS1.1 - Selezione Pattern e Modello <UCS1.1>
  *Attore principale:* Utente del Simulatore\
  *Pre-condizioni:* \
  ...
  *Trigger:* Definizione della variabilità del dato nel tempo.\
  ...
  ==== UCS1.2 - Mappatura Sensori - Tipi di Dati <UCS1.2>
  *Attore principale:* Utente del Simulatore\
  *Pre-condizioni:* \
  ...
  *Trigger:* Collegamento logico tra generatore matematico e dispositivo virtuale.\
  ...
  === UCS2 - Esecuzione Simulazione e Invio Dati <UCS2>
  ...
  *Trigger:* Avvio manuale del test o schedulazione automatica.\
  ...
  === UCS3 - Gestione Anomalie (Fault Injection) <UCS3>
  *Attore principale:* Utente del Simulatore\
  *Pre-condizioni:* \
  ...
  *Trigger:* Verifica della robustezza del Cloud e del sistema di Alerting (Chaos Engineering).\
  ...
  === UCS4 - Generazione Spike/Drop/Outlier <UCS4>
  *Attore principale:* Utente del Simulatore\
  *Pre-condizioni:* \
  ...
  *Trigger:* Necessità di verificare se il Cloud rileva correttamente i superamenti di soglia e genera gli allarmi.\
  ...
  === UCS5 - Generazione Latenza/Packet Loss <UCS5>
  *Attore principale:* Utente del Simulatore\
  *Pre-condizioni:* \
  - L'Utente è nel pannello Anomalie (vedi [@UCS3[UCS3,]]).\
  *Post-condizioni:* \
  ...
  *Trigger:* Verifica della gestione della Quality of Service (QoS) e dei meccanismi di buffering/ritrasmissione lato Cloud.\
  ...
  === UCS6 - Invio Comandi di Configurazione Remota <UCS6>
  ...
  *Trigger:* Modifica delle impostazioni effettuata dall'Admin sulla console Cloud.\
  ...
  === UCS7 - Dati Simulazione Non Validi <UCS7>
  *Attore principale:* Utente del Simulatore\
  *Pre-condizioni:* \
  ...
  *Trigger:* Errore di input nella definizione del modello dati.\
  ...
  === UCS8 - Fallimento Connessione al Cloud <UCS8>
  *Attore principale:* Utente del Simulatore\
  *Pre-condizioni:* \
  ...
  *Trigger:* Tentativo di avvio simulazione con credenziali errate o rete indisponibile.\
  ...
  === UCS9 - Visualizzazione Log Simulatore <UCS9>
  *Attore principale:* Utente del Simulatore\
  *Pre-condizioni:* \
