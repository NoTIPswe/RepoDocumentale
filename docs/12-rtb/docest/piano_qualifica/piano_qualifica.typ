...
#base-document.apply-base-document(
  ...
  [T-S-001],[Verificare che il Sistema permetta all’utente non autenticato di effettuare il login.],[R-1-F],[NI],
  [T-S-002],[Verificare che il Sistema, durante il login, permetta all’utente non autenticato di inserire una mail per autenticarsi.],[R-2-F],[NI],
  [T-S-003],[Verificare che il Sistema, durante il login, permetta all’utente non autenticato di inserire la password per autenticarsi.],[R-3-F],[NI],
  [T-S-004],[Verificare che il Sistema notifichi l’utente non autenticato in seguito ad un tentativo di autenticazione non andato a buon fine.],[R-4-F],[NI],
  [T-S-005],[Verificare che il Sistema permetta all’utente non autenticato di effettuare la configurazione iniziale del TOTPG per garantire il login 2FA.],[R-5-F],[NI],
  [T-S-006],[Verificare che il Sistema permetta all’utente non autenticato di effettuare il login 2FA.],[R-6-F],[NI],
  [T-S-007],[Verificare che il Sistema permetta all’utente di inserire il codice numerico 2FA.],[R-7-F],[NI],
  [T-S-008],[Verificare che il Sistema permetta all’utente di confermare il codice numerico inserito.],[R-8-F],[NI],
  [T-S-009],[Verificare che il Sistema notifichi l’utente in seguito a un tentativo di autenticazione 2FA non andato a buon fine.],[R-9-F],[NI],
  [T-S-010],[Verificare che il Sistema permetta all’utente non autenticato di recuperare la password.],[R-10-F],[NI],
  [T-S-011],[Verificare che il Sistema notifichi l’utente non autenticato di aver inserito un’email non associata ad un account.],[R-11-F],[NI],
  [T-S-012],[Verificare che il Sistema permetta l’inserimento della mail per il recupero password.],[R-12-F],[NI],
  [T-S-013],[Verificare che il Sistema permetta l’inserimento della password per il recupero password.],[R-13-F],[NI],
  [T-S-014],[Verificare che il Sistema permetta la conferma della password per il recupero.],[R-14-F],[NI],
  [T-S-015],[Verificare che il Sistema permetta il recupero password tramite codice di verifica.],[R-15-F],[NI],
  [T-S-016],[Verificare che il Sistema permetta l’inserimento del codice numerico di recupero.],[R-16-F],[NI],
  [T-S-017],[Verificare che il Sistema permetta la conferma del codice numerico di recupero.],[R-17-F],[NI],
  [T-S-018],[Verificare che il Sistema notifichi l’utente in caso di codice di recupero errato.],[R-18-F],[NI],
  [T-S-019],[Verificare che il Sistema permetta la reimpostazione della password.],[R-19-F],[NI],
  [T-S-020],[Verificare che il Sistema permetta l’inserimento della nuova password.],[R-20-F],[NI],
  [T-S-021],[Verificare che il Sistema permetta la conferma della nuova password.],[R-21-F],[NI],
  [T-S-022],[Verificare che il Sistema avvisi la presenza di password non conforme ai requisiti di sicurezza.],[R-22-F],[NI],
  [T-S-023],[Verificare che il Sistema completi la reimpostazione della password.],[R-23-F],[NI],
  [T-S-024],[Verificare che il Sistema permetta all’utente autenticato di visualizzare la dashboard.],[R-24-F],[NI],
  [T-S-025],[Verificare che il Sistema permetta la selezione di un sensore.],[R-25-F],[NI],
  [T-S-026],[Verificare che il Sistema permetta la visualizzazione dei dati del sensore selezionato.],[R-26-F],[NI],
  [T-S-027],[Verificare che il Sistema permetta la selezione del range temporale dei dati.],[R-27-F],[NI],
  [T-S-028],[Verificare che il Sistema visualizzi i dati nel range temporale selezionato.],[R-28-F],[NI],
  [T-S-029],[Verificare che il Sistema visualizzi i dati con granularità adeguata.],[R-29-F],[NI],
  [T-S-030],[Verificare che il Sistema permetta l’esportazione dei dati del sensore.],[R-30-F],[NI],
  [T-S-031],[Verificare che il Sistema permetta la visualizzazione dello stream in tempo reale.],[R-31-F],[NI],
  [T-S-032],[Verificare che il Sistema permetta la messa in pausa dello stream.],[R-32-F],[NI],
  [T-S-033],[Verificare che il Sistema permetta la ripresa dello stream.],[R-33-F],[NI],
  [T-S-034],[Verificare che il Sistema in occorrenza notifichi la perdita di connessione.],[R-34-F],[NI],
  [T-S-035],[Verificare che il Sistema permetta l’impostazione delle soglie di alert.],[R-35-F],[NI],
  [T-S-036],[Verificare che il Sistema in occorrenza notifichi il superamento delle soglie di alert.],[R-36-F],[NI],
  [T-S-037],[Verificare che il Sistema permetta la visualizzazione della lista degli eventuali alert.],[R-37-F],[NI],
  [T-S-038],[Verificare che il Sistema permetta la selezione di un eventuale alert.],[R-38-F],[NI],
  [T-S-039],[Verificare che il Sistema permetta la visualizzazione dei dettagli dell’alert selezionato.],[R-39-F],[NI],
  [T-S-040],[Verificare che il Sistema permetta la disattivazione di un alert.],[R-40-F],[NI],
  [T-S-041],[Verificare che il Sistema permetta la visualizzazione della lista dei sensori.],[R-41-F],[NI],
  [T-S-042],[Verificare che il Sistema permetta il filtraggio della lista dei sensori.],[R-42-F],[NI],
  [T-S-043],[Verificare che il Sistema permetta la visualizzazione della lista dei gateway.],[R-43-F],[NI],
  [T-S-044],[Verificare che il Sistema permetta la visualizzazione dei dettagli di un gateway.],[R-44-F],[NI],
  [T-S-045],[Verificare che il Sistema permetta la visualizzazione dell’ID di fabbrica del gateway.],[R-45-F],[NI],
  [T-S-046],[Verificare che il Sistema permetta la visualizzazione della configurazione del gateway.],[R-46-F],[NI],
  [T-S-047],[Verificare che il Sistema permetta la visualizzazione dei sensori del gateway.],[R-47-F],[NI],
  [T-S-048],[Verificare che il Sistema permetta la creazione/associazione di un sensore.],[R-48-F],[NI],
  [T-S-049],[Verificare che il Sistema permetta l’inserimento dei dati di configurazione del sensore.],[R-49-F],[NI],
  [T-S-050],[Verificare che il Sistema che il Sistema deve notificare che il range inserito è invalido.],[R-50-F],[NI],
  [T-S-051],[Verificare che il Sistema che il Sistema deve notificare che il valore numerico inserito non è valido.],[R-51-F],[NI],
  [T-S-052],[Verificare che il Sistema permetta l’inserimento dell’identificativo del sensore.],[R-52-F],[NI],
  [T-S-053],[Verificare che il Sistema permetta l’inserimento della tipologia del sensore.],[R-53-F],[NI],
  [T-S-054],[Verificare che il Sistema permetta l’inserimento della frequenza di invio dati.],[R-54-F],[NI],
  [T-S-055],[Verificare che il Sistema permetta la conferma della creazione del sensore.],[R-55-F],[NI],
  [T-S-056],[Verificare che il Sistema che il Sistema deve notificare errore durante la creazione del sensore.],[R-56-F],[NI],
  [T-S-057],[Verificare che il Sistema permetta l’eliminazione di un sensore.],[R-57-F],[NI],
  [T-S-058],[Verificare che il Sistema permetta la conferma dell’eliminazione del sensore.],[R-58-F],[NI],
  [T-S-059],[Verificare che il Sistema che il Sistema deve notificare errore durante l’eliminazione del sensore.],[R-59-F],[NI],
  [T-S-060],[Verificare che il Sistema permetta la creazione di un gateway.],[R-60-F],[NI],
  [T-S-061],[Verificare che il Sistema permetta l’inserimento dei dati di configurazione del gateway.],[R-61-F],[NI],
  [T-S-062],[Verificare che il Sistema permetta l’inserimento della chiave segreta del gateway.],[R-62-F],[NI],
  [T-S-063],[Verificare che il Sistema permetta l’inserimento del numero di serie del gateway.],[R-63-F],[NI],
  [T-S-064],[Verificare che il Sistema permetta l’inserimento della versione software del gateway.],[R-64-F],[NI],
  [T-S-065],[Verificare che il Sistema permetta l’inserimento del modello del gateway.],[R-65-F],[NI],
  [T-S-066],[Verificare che il Sistema permetta la conferma della creazione del gateway.],[R-66-F],[NI],
  [T-S-067],[Verificare che il Sistema che il Sistema deve notificare errore durante la creazione del gateway.],[R-67-F],[NI],
  [T-S-068],[Verificare che il Sistema permetta l’eliminazione di un gateway.],[R-68-F],[NI],
  [T-S-069],[Verificare che il Sistema permetta la conferma dell’eliminazione del gateway.],[R-69-F],[NI],
  [T-S-070],[Verificare che il Sistema che il Sistema deve notificare errore durante l’eliminazione del gateway.],[R-70-F],[NI],
  [T-S-071],[Verificare che il Sistema permetta la visualizzazione della lista dei tenant.],[R-71-F],[NI],
  [T-S-072],[Verificare che il Sistema permetta la selezione di un tenant.],[R-72-F],[NI],
  [T-S-073],[Verificare che il Sistema permetta la visualizzazione dei dettagli del tenant.],[R-73-F],[NI],
  [T-S-074],[Verificare che il Sistema permetta la visualizzazione dello stato del tenant.],[R-74-F],[NI],
  [T-S-075],[Verificare che il Sistema permetta l’attivazione del tenant.],[R-75-F],[NI],
  [T-S-076],[Verificare che il Sistema permetta la sospensione del tenant.],[R-76-F],[NI],
  [T-S-077],[Verificare che il Sistema che il Sistema deve notificare transizione di stato non consentita.],[R-77-F],[NI],
  [T-S-078],[Verificare che il Sistema permetta la visualizzazione della lista degli utenti del tenant.],[R-78-F],[NI],
  [T-S-079],[Verificare che il Sistema permetta la creazione di un utente per un tenant.],[R-79-F],[NI],
  [T-S-080],[Verificare che il Sistema permetta l’inserimento dei dati dell’utente.],[R-80-F],[NI],
  [T-S-081],[Verificare che il Sistema permetta l’inserimento della mail dell’utente.],[R-81-F],[NI],
  [T-S-082],[Verificare che il Sistema che il Sistema deve notificare mail non valida.],[R-82-F],[NI],
  [T-S-083],[Verificare che il Sistema permetta l’inserimento della password dell’utente.],[R-83-F],[NI],
  [T-S-084],[Verificare che il Sistema che il Sistema deve notificare password non conforme.],[R-84-F],[NI],
  [T-S-085],[Verificare che il Sistema permetta l’assegnazione del ruolo all’utente.],[R-85-F],[NI],
  [T-S-086],[Verificare che il Sistema permetta la conferma della creazione dell’utente.],[R-86-F],[NI],
  [T-S-087],[Verificare che il Sistema che il Sistema deve notificare errore durante la creazione dell’utente.],[R-87-F],[NI],
  [T-S-088],[Verificare che il Sistema permetta l’eliminazione di un utente.],[R-88-F],[NI],
  [T-S-089],[Verificare che il Sistema permetta la conferma dell’eliminazione dell’utente.],[R-89-F],[NI],
  [T-S-090],[Verificare che il Sistema che il Sistema deve notificare errore durante l’eliminazione dell’utente.],[R-90-F],[NI],
  [T-S-091],[Verificare che il Sistema permetta la visualizzazione dei log di audit del tenant.],[R-91-F],[NI],
  [T-S-092],[Verificare che il Sistema permetta l’esportazione dei log di audit del tenant.],[R-92-F],[NI],
  [T-S-093],[Verificare che il Sistema permetta il monitoraggio delle prestazioni complessive.],[R-93-F],[NI],
  [T-S-094],[Verificare che il Sistema permetta il monitoraggio della latenza media.],[R-94-F],[NI],
  [T-S-095],[Verificare che il Sistema permetta il monitoraggio del volume di traffico.],[R-95-F],[NI],
  [T-S-096],[Verificare che il Sistema permetta il monitoraggio dell’utilizzo dello storage.],[R-96-F],[NI],
  [T-S-097],[Verificare che il Sistema che l’Amministratore di Sistema possa avviare una sessione di impersonificazione.],[R-124-F],[NI],
  [T-S-098],[Verificare che il Sistema che l’Amministratore di Sistema possa registrare e associare un Gateway a un Tenant.],[R-125-F],[NI],
  [T-S-099],[Verificare che il Sistema che l’Amministratore di Sistema possa creare un Utente Amministratore Tenant.],[R-126-F],[NI],
  [T-S-100],[Verificare che il Sistema che l’Amministratore di Sistema possa visualizzare i log di audit di un Tenant.],[R-127-F],[NI],
  [T-S-101],[Verificare che il Sistema che l’Amministratore di Sistema possa esportare i log di audit di un Tenant.],[R-128-F],[NI],
  [T-S-102],[Verificare che il Sistema che l’Amministratore di Sistema possa monitorare le prestazioni complessive del Sistema.],[R-129-F],[NI],
  [T-S-103],[Verificare che il Sistema che un Gateway non provisioned possa attivarsi e connettersi correttamente.],[R-130-F],[NI],
  [T-S-104],[Verificare che il Sistema che un Gateway non provisioned riceva errore di autenticazione.],[R-131-F],[NI],
  [T-S-105],[Verificare che il Sistema che un Gateway provisioned invii dati cifrati al Cloud.],[R-132-F],[NI],
  [T-S-106],[Verificare che il Sistema che un Gateway non provisioned apra un canale di comunicazione sicuro.],[R-133-F],[NI],
  [T-S-107],[Verificare che il Sistema che un Gateway provisioned riceva notifica di autenticazione fallita.],[R-134-F],[NI],
  [T-S-108],[Verificare che il Sistema che il Tenant Admin riceva notifica di range invalido.],[R-135-F],[NI],

  [T-S-109],[Verificare che il Sistema che l’Utente del Simulatore possa visualizzare la lista dei Gateway simulati.],[R-S-1-F],[NI],
  [T-S-110],[Verificare che il Sistema che sia possibile visualizzare un Gateway simulato con data di creazione.],[R-S-2-F],[NI],
  [T-S-111],[Verificare che il Sistema che sia possibile visualizzare l’ID di fabbrica del Gateway simulato.],[R-S-3-F],[NI],
  [T-S-112],[Verificare che il Sistema che sia possibile visualizzare la configurazione di simulazione del Gateway.],[R-S-4-F],[NI],
  [T-S-113],[Verificare che il Sistema che sia possibile visualizzare i sensori del Gateway simulato.],[R-S-5-F],[NI],
  [T-S-114],[Verificare che il Sistema che sia possibile visualizzare un sensore simulato.],[R-S-6-F],[NI],
  [T-S-115],[Verificare che il Sistema che sia possibile visualizzare la configurazione di un sensore simulato.],[R-S-7-F],[NI],
  [T-S-116],[Verificare che il Sistema che sia possibile eliminare un Gateway simulato.],[R-S-8-F],[NI],
  [T-S-117],[Verificare che il Sistema che sia possibile eliminare un sensore simulato.],[R-S-9-F],[NI],
  [T-S-118],[Verificare che il Sistema che sia possibile creare e fare il deploy di un Gateway simulato.],[R-S-10-F],[NI],
  [T-S-119],[Verificare che il Sistema che sia possibile inserire i dati di configurazione del Gateway simulato.],[R-S-11-F],[NI],
  [T-S-120],[Verificare che il Sistema che venga notificato errore durante il deploy del Gateway simulato.],[R-S-12-F],[NI],
  [T-S-121],[Verificare che il Sistema che sia possibile creare un sensore simulato.],[R-S-13-F],[NI],
  [T-S-122],[Verificare che il Sistema che sia possibile inserire i dati di configurazione del sensore simulato.],[R-S-14-F],[NI],
  [T-S-123],[Verificare che il Sistema che venga notificato range di generazione dati invalido.],[R-S-15-F],[NI],
  [T-S-124],[Verificare che il Sistema che venga notificato errore durante la creazione del sensore simulato.],[R-S-16-F],[NI],
  [T-S-125],[Verificare che il Sistema il comportamento con più Gateway simulati in parallelo.],[R-S-17-F],[NI],
  [T-S-126],[Verificare che il Sistema che venga notificato valore numerico non valido nel simulatore.],[R-S-18-F],[NI],
  [T-S-127],[Verificare che il Sistema il comportamento in caso di degrado della rete.],[R-S-19-F],[NI],
  [T-S-128],[Verificare che il Sistema il comportamento in caso di disconnessione temporanea della rete.],[R-S-20-F],[NI],
  [T-S-129],[Verificare che il Sistema il comportamento in presenza di valori di sensore inaspettati.],[R-S-21-F],[NI],
  [T-S-130],[Verificare che il Sistema la modifica della configurazione del Gateway da parte del Cloud.],[R-S-22-F],[NI],
  [T-S-131],[Verificare che il Sistema la notifica di payload di configurazione invalido al Cloud.],[R-S-23-F],[NI],
  [T-S-132],[Verificare che il Sistema la notifica di frequenza sintatticamente corretta ma non accettabile.],[R-S-24-F],[NI],

  [T-S-133],[Verificare che il Sistema la cifratura dei dati in transito e a riposo.],[R-1-S],[NI],
  [T-S-134],[Verificare che il Sistema la segregazione dei dati tra Tenant.],[R-2-S],[NI],
  [T-S-135],[Verificare che il Sistema l’accesso tramite autenticazione a più fattori.],[R-3-S],[NI],
  [T-S-136],[Verificare che il Sistema la presenza e consultabilità dei log di sicurezza.],[R-4-S],[NI],
  [T-S-137],[Verificare che il Sistema la protezione da attacchi tramite rate limiting e failover.],[R-5-S],[NI],
  [T-S-138],[Verificare che il Sistema l’autenticazione robusta con ruoli e permessi granulari.],[R-6-S],[NI],
