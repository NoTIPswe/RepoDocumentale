...
#base-document.apply-base-document(
  ...
  [La maggior parte del team non aveva esperienza con tecnologie di messagging come NATS], [Studio della documentazione ufficiale e realizzazione di prototipi incrementali per validarne l'utilizzo nel PoC], [NATS JetStream (MQTT)],
