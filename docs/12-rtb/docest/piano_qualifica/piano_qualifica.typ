...
<<<<<<< HEAD
    ...
    [T-U-14], [Verificare il mapping dello stato gateway verso label testuale.], [R-22-F], [NI],
    [T-U-15], [Verificare la formattazione del timestamp ultimo invio gateway.], [R-23-F], [NI],
    [T-U-16], [Verificare la formattazione del timestamp ultimo invio sensore.], [R-24-F], [NI],
    [T-U-17], [Verificare la normalizzazione e serializzazione dello stream dati.], [R-25-F], [NI],
    [T-U-18], [Verificare la trasformazione dello stream in struttura tabellare.], [R-26-F], [NI],
    [T-U-19], [Verificare la trasformazione dello stream in serie per grafico.], [R-27-F], [NI],
    [T-U-20], [Verificare la validazione dell’intervallo temporale (start ≤ end).], [R-30-F], [NI],
    [T-U-21], [Verificare il mapping dello stato “dati non disponibili”.], [R-31-F], [NI],
    [T-U-22], [Verificare la serializzazione dei dati per export.], [R-32-F], [NI],
    [T-U-23], [Verificare la formattazione del valore fuori range.], [R-34-F], [NI],
    [T-U-24], [Verificare la formattazione del range accettato.], [R-34-F], [NI],
    [T-U-25], [Verificare la formattazione del timestamp di un dato irregolare.], [R-34-F], [NI],

    [T-U-26], [Verificare il mapping del tipo di alert verso descrizione testuale.], [R-36-F], [NI],
    [T-U-27], [Verificare il mapping dell’hardware interessato da un alert.], [R-36-F], [NI],
    [T-U-28], [Verificare la formattazione del timestamp di emissione alert.], [R-36-F], [NI],
    [T-U-29], [Verificare la validazione delle impostazioni di notifica.], [R-40-F, R-41-F], [NI],
    ...
    [T-U-37], [Verificare la validazione di un token JWT (scadenza e formato).], [R-83-F], [NI],

    [T-U-38], [Verificare il mapping della lista gateway simulati.], [R-S-1-F], [NI],
    [T-U-39], [Verificare il mapping del gateway simulato.], [R-S-2-F], [NI],
    [T-U-40], [Verificare la validazione della configurazione gateway simulato.], [R-S-11-F], [NI],
    [T-U-41], [Verificare il mapping dell’errore di deploy gateway simulato.], [R-S-12-F], [NI],
    [T-U-42], [Verificare la validazione della configurazione sensore simulato.], [R-S-14-F], [NI],
    [T-U-43], [Verificare il mapping dell’errore range invalido sensore.], [R-S-15-F], [NI],
=======
    [T-U-1], [Verificare la validazione del campo email nella richiesta di login (presenza e formato)], [R-2-F], [NI],
    [T-U-2], [Verificare la validazione del campo password nella richiesta di login], [R-3-F], [NI],
    [T-U-3], [Verificare il mapping dell’errore “credenziali errate”], [R-4-F], [NI],
...
>>>>>>> c35c979b40dafee5588afe53bd875349ebb4a3a1
  )
...
<<<<<<< HEAD
    ...
    [T-S-011],
    [Verificare che il Sistema permetta ad un utente autenticato di modificare la propria email e di ricevere una
      notificare qualora questa sia presente già in un altro account oppure non sia valida.],
    [R-15-F, R-16-F, R-17-F, R-18-F],
    [NI],

    [T-S-012],
    [Verificare che il Sistema permetta ad un utente autenticato di modificare la propria password.],
    [R-19-F],
    [NI],

    [T-S-013], [Verificare che un utente autenticato possa effettuare la disconnessione dal Sistema.], [R-20-F], [NI],
    //Gateway e Sensori
    [T-S-014],
    ...
    [T-S-018],
    [Verificare che il Sistema visualizzi i dati di stream sia in formato tabella, sia in formato grafico.],
    [R-25-F, R-26-F, R-27-F],
    [NI],
    ...
    [T-S-021], [Verificare che l’utente possa esportare i dati visualizzati in formato supportato.], [R-32-F], [NI],

    //Alert e Notifiche
    [T-S-022], [Verificare che il Sistema generi un alert in caso di Gateway non raggiungibile.], [R-33-F], [NI],
    [T-S-023], [Verificare che il Sistema generi un alert in caso di valore sensore fuori range.], [R-34-F], [NI],

    [T-S-024], [Verificare che l’utente possa visualizzare lo storico degli alert generati.], [R-35-F], [NI],
    [T-S-025],
    ...
    [T-S-027],
    [Verificare che il Tenant Admin possa modificare il nome di un Gateway e ricevere errore in caso di duplicato.],
    [R-42-F, R-43-F],
    [NI],

    [T-S-028],
    [Verificare che il Tenant Admin possa modificare lo stato operativo di un Gateway.],
    [R-44-F, R-45-F],
    [NI],
...
<<<<<<< HEAD
    [T-S-030],
    [Verificare che il Tenant Admin possa visualizzare, creare, modificare ed eliminare utenti del Tenant.],
    [R-57-F, R-58-F, R-59-F, R-60-F, R-61-F, R-62-F, R-63-F, R-64-F, R-65-F],
    [NI],

    [T-S-031],
    [Verificare che l'Amministratore di Sistema possa visualizzare, creare, modificare, sospendere, riattivare ed
      eliminare un Tenant.],
    [R-92-F, R-93-F, R-94-F, R-95-F, R-96-F, R-97-F, R-98-F, R-99-F, R-101-F, R-102-F, R-103-F, R-104-F, R-105-F,
      R-106-F, R-107-F],
    [NI],
    ...
    [R-67-F, R-68-F, R-69-F, R-70-F, R-71-F, R-72-F],
    [NI],

    [T-S-034], [Verificare che il Sistema registri tutte le operazioni rilevanti nei log di Audit.], [R-4-S], [NI],

    [T-S-035],
    [Verificare che un utente autorizzato possa consultare ed esportare i log di Audit ed eventualmente fare il download
      in locale.],
    [R-74-F, R-75-F, R-76-F, R-77-F, R-78-F],
    [NI],

    [T-S-036], [Verificare che il Sistema mostri metriche di latenza, traffico e utilizzo storage.], [R-111-F], [NI],
    ...
    [R-S-1-F, R-S-2-F, R-S-3-F, R-S-4-F, R-S-5-F, R-S-6-F],
    [NI],

    [T-S-041],
    [Verificare che l’utente possa configurare e simulare sensori associati a un Gateway simulato.],
    [R-S-7-F, R-S-8-F, R-S-9-F, R-S-10-F, R-S-11-F, R-S-12-F, R-S-13-F, R-S-14-F, R-S-15-F, R-S-16-F],
    [NI],

    [T-S-042],
    [Verificare che il simulatore permetta di iniettare anomalie di rete e valori sensore anomali.],
    [R-S-17-F, R-S-18-F, R-S-19-F, R-S-20-F, R-S-21-F],
    [NI],

    [T-S-043],
    [Verificare che il Cloud possa inviare configurazioni al Gateway simulato e ricevere notifiche di errore.],
=======
    [T-S-028],
