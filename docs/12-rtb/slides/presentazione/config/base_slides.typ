...
#let apply-base-slides(
  ...
  set page(
    paper: slide-paper,
    margin: (top: 1.2cm, x: slide-margin-x, bottom: 1.3cm),
  )
  ...
  context {
    ...
    align(center + horizon)[
      #grid(columns: (auto, 1fr, auto), align: center)[
        #image("../../../../00-common_assets/logo_unipd.png", height: 3cm)
      ][][
        #image("../../../../00-common_assets/logo.png", height: 3cm)
      ]
      #v(1em)
  ...
  context {
    ...
    show heading.where(level: 2): it => {
      ...
      underline(
        stroke: 4pt + base-configs.color-primary,
        offset: 13pt,
        it.body,
      )
    }
